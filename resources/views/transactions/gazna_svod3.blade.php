...
@section('title', 'Свод 3 — Газна йиллик фоиз')
...
<div class="report-wrap">
    <div class="report-head">
        <div class="report-title">
            <h1>Свод 3 — Газна йиллик фоиз</h1>
            <div class="sub">Манба: storage/app/public/detalization/FORMULAS_GAZNA.csv</div>
        </div>
    ...
    <div class="switch-row">
        ...
        <a href="{{ route('gazna.svod2') }}" class="switch-link">Gazna Svod2</a>
        <a href="{{ route('gazna.svod3') }}" class="switch-link active">Gazna Svod3</a>
